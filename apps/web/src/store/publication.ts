...
interface PublicationState {
  ...
  attachments: NewSphrexAttachment[];
  setAttachments: (attachments: NewSphrexAttachment[]) => void;
  addAttachments: (attachments: NewSphrexAttachment[]) => void;
  updateAttachments: (attachments: NewSphrexAttachment[]) => void;
