...
const Footer: FC = () => {
  ...
  return (
    ...
    >
      ...
      <a
        href="https://feedback.sphrex.xyz"
        target="_blank"
        rel="noreferrer noopener"
      ...
      <a
        href="https://github.com/sphrexxyz/sphrex"
        target="_blank"
        rel="noreferrer noopener"
