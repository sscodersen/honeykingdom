          ...
          <div className="relative mx-auto rounded-lg sm:w-2/4 max-w-3/4">
            <div className="!p-8 max-w-none text-gray-600 dark:text-gray-200">
              ...
              <div className="space-y-5 leading-7">
                <p>
                  The website sphrex.xyz” (the “Site”) offers information, tools and services to you to allow
                  you to interact with the Lens Protocol - a composable and decentralised social graph
                  protocol.
                </p>
                <p>
                  By visiting the Site, you agree to be bound by the following terms and conditions (“Terms”),
                  including those additional terms and conditions and policies referenced herein and/or
                  available by hyperlink (collectively, the “Agreement”). The Agreement applies to all users
                  of the Site, including without limitation users who are browsers, builders, and/or
                  contributors of content.
                </p>
                <p>
                  Please read these Terms carefully before accessing or using the Site. If you do not agree to
                  all the terms of the Agreement, then you should not access the Site; however, by accessing
                  the Site, you consent to the Agreement.
                </p>
                <p>
                  ...
                  to our Site. It is your responsibility to check this page periodically for changes. Your
                  continued use of or access to the Site following the posting of any changes constitutes
              ...
              {/* 3. Services begins */}
              <div className="mt-8 mb-5 text-xl font-bold text-black dark:text-white">3. Services</div>
              <div className="space-y-5 leading-7">
                <p>User Lens profile is referred as the “Profile” in the “Site”.</p>
                <p>
                ...
                <ul className="space-y-3 list-disc list-inside">
                  ...
                  <li>You are responsible for securing the wallet that contains your profiles.</li>
                  <li>
                ...
                <p>
                  ...
                  possession, custody or control over any items on your wallet and we do not have possession,
                  custody, ability to delete or control over any items on any user’s wallet or interactions
                  with the Lens Protocol.
                </p>
                <p>
                  If you’re not comfortable with interacting with an inherently transparent blockchain, you
                  should not engage with our Site to create and manage a content on the Lens Protocol. You are
                  solely responsible for the safekeeping of the private key associated with the blockchain
                  address used to interact with the Lens Protocol.{' '}
                  <b>
              ...
              <div className="space-y-5 leading-7">
                <p>
                  We are not responsible for any mistakes or inaccuracies on contents published on this Site.
                  Profiles are fully responsible for what they are doing in the Site.
                </p>
                <p>
              ...
              <p className="leading-7">
                ...
                thereof) without notice at any time. We shall not be liable to you or any third-party for any
                modification, information change, suspension or discontinuance of the Site.
              </p>
              ...
              <div className="space-y-5 leading-7">
                <p>
                  ...
                  property rights of other people, harassment or otherwise abusive behaviour, spreading false
                  information or viruses, spamming, or interfering with the security features of the Site.
                </p>
                ...
                <ul className="space-y-2 list-disc list-inside">
                  ...
                  <li>
                    to collect or track the personal information of others to spam, phish, pretext, crawl, or
                    scrape;
                  </li>
                  <li>
              ...
              <p className="leading-7">
                ...
                inability to use, the Site is at your sole risk. Our liability shall be limited entirely or to
              ...
              <div className="space-y-5 leading-7">
                ...
                <p>
                  If in our sole judgment you fail to comply with terms, we reserve the right to terminate our
                  Agreement with you and deny you access to the Site.
                </p>
              </div>
              ...
              <p className="leading-7">Questions about the Terms should be sent to us at terms@sphrex.xyz</p>
