...
import type { SphrexAttachment, SphrexPublication } from '@generated/types';
...
const NewPublication: FC<Props> = ({ publication }) => {
  ...
  const createPublication = async () => {
    ...
    try {
      ...
      const attachmentsInput: SphrexAttachment[] = attachments.map((attachment) => ({
      ...
      const metadata: PublicationMetadataV2Input = {
        ...
        external_url: `https://sphrex.xyz/u/${currentProfile?.handle}`,
