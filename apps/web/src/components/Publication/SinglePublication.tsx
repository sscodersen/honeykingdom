    ...
    <article className="hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer first:rounded-t-xl last:rounded-b-xl p-5">
      ...
      >
        {publication?.hidden ? (
          ...
          <>
            <PublicationBody publication={rootPublication as SphrexPublication} />
            {showActions && (
              <PublicationActions
                publication={rootPublication as SphrexPublication}
                electedMirror={feedItem?.electedMirror as ElectedMirror}
              />
            )}
            {showModActions && <ModAction publication={rootPublication as SphrexPublication} />}
          </>
        )}
      </div>
    </article>
