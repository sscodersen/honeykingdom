...
export const SERVERLESS_MAINNET_API_URL = 'https://api.sphrex.xyz';
export const SERVERLESS_TESTNET_API_URL = 'https://api-testnet.sphrex.xyz';
export const SERVERLESS_STAGING_API_URL = 'https://api-staging.sphrex.xyz';
export const SERVERLESS_STAGING_SANDBOX_API_URL = 'https://api-staging-sandbox.sphrex.xyz';
export const SERVERLESS_SANDBOX_API_URL = 'https://api-sandbox.sphrex.xyz';
...
// Misc
export const CONTACT_EMAIL = 'support@sphrex.xyz';
...
// URLs
export const STATIC_ASSETS_URL = 'https://assets.sphrex.xyz';
export const STATIC_IMAGES_URL = `${STATIC_ASSETS_URL}/images`;
export const POLYGONSCAN_URL = IS_MAINNET ? 'https://polygonscan.com' : 'https://mumbai.polygonscan.com';
export const RARIBLE_URL = IS_MAINNET ? 'https://rarible.com' : 'https://rinkeby.rarible.com';
export const MEDIA_PROXY_URL = 'https://media.sphrex.xyz';
export const OG_MEDIA_PROXY_URL = 'https://og-media.sphrex.xyz';
export const ARWEAVE_GATEWAY = 'https://arweave.net';
export const IPFS_GATEWAY = 'https://lens.infura-ipfs.io/ipfs/';
export const EVER_API = 'https://endpoint.4everland.co';
export const SIMPLEANALYTICS_API = 'https://simpleanalytics.com/sphrex.xyz.json';
