...
export type SphrexStatsQueryVariables = Exact<{ [key: string]: never }>;

export type SphrexStatsQuery = {
  __typename?: 'Query';
  globalProtocolStats: {
    __typename?: 'GlobalProtocolStats';
...
>;
export const SphrexStatsDocument = gql`
  query SphrexStats {
    globalProtocolStats(request: { sources: "Sphrex" }) {
      totalProfiles
      totalPosts
      totalBurntProfiles
      totalMirrors
...
/**
 * __useSphrexStatsQuery__
 *
 * To run a query within a React component, call `useSphrexStatsQuery` and pass it any options that fit your needs.
 * When your component renders, `useSphrexStatsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSphrexStatsQuery({
 *   variables: {
 *   },
 * });
 */
export function useSphrexStatsQuery(
  baseOptions?: Apollo.QueryHookOptions<SphrexStatsQuery, SphrexStatsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SphrexStatsQuery, SphrexStatsQueryVariables>(SphrexStatsDocument, options);
}
export function useSphrexStatsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<SphrexStatsQuery, SphrexStatsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<SphrexStatsQuery, SphrexStatsQueryVariables>(SphrexStatsDocument, options);
}
export type SphrexStatsQueryHookResult = ReturnType<typeof useSphrexStatsQuery>;
export type SphrexStatsLazyQueryHookResult = ReturnType<typeof useSphrexStatsLazyQuery>;
export type SphrexStatsQueryResult = Apollo.QueryResult<SphrexStatsQuery, SphrexStatsQueryVariables>;
